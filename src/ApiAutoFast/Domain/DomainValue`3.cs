...
public class DomainValue<TRequestValue, TEntityValue, TDomain> where TDomain : DomainValue<TRequestValue, TEntityValue, TDomain>, new()
{
    static DomainValue()
    {
    ...
    public TEntityValue EntityValue { get; private set; } = default!;
