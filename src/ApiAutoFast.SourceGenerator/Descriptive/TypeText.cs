namespace ApiAutoFast.SourceGenerator.Descriptive;
...
internal static class TypeText
{
    ...
    internal const string StringDomainValue1 = "StringDomainValue`1";
    internal const string StringDomainValue = "StringDomainValue";
