...
namespace ApiAutoFast.Sample.Server.Migrations
{
    ...
    [Migration("20220719140815_AddAuthor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiAutoFast.Sample.Server.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AuthorBlog", b =>
                {
                    b.HasOne("ApiAutoFast.Sample.Server.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiAutoFast.Sample.Server.Blog", null)
                        .WithMany()
